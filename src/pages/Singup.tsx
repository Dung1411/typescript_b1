              ...
              <div className="w-full">
                ...
                <div>
                  ...
                  <input type="text" {...register("name",{
                    required : true
                  })}  className="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600" placeholder="Name" />
                </div>
                <div className="mt-4">
                  <label className="block text-sm">
                    Email
                  ...
                  <input {...register("email",{
                    required : true
                  })} type="email" className="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600" placeholder="Email Address" />
                </div>
                <div>
                  ...
                  <input {...register("password",{
                    required : true
                  })} className="w-full px-4 py-2 text-sm border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600" placeholder="Password" type="password" />
                </div>
                ...
                <div className="mt-4 text-center">
                  <p className="text-sm">Don't have an account yet? <a href="" className="text-blue-600 hover:underline"> Sign up.</a></p>
                </div>
              </div>
            </div>
          </div>
